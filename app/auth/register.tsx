...
export default function RegisterScreen() {
  ...
  const confirmPasswordInputElevation = useRef(new Animated.Value(2)).current
  ...
  const handleInputFocus = (inputName: string) => {
    ...
    const targetScale = inputName === "email" ? emailInputScale : 
                       inputName === "password" ? passwordInputScale : 
                       confirmPasswordInputScale
    
    // Reset all scales first
    emailInputScale.setValue(1)
    passwordInputScale.setValue(1)
    confirmPasswordInputScale.setValue(1)
            ...
            <Animated.View
              style={[
                styles.inputContainer,
                {
                  ...
                  transform: [
                    { scale: confirmPasswordInputScale },
                    {
                      translateX: errorShakeAnim.interpolate({
                        inputRange: [-10, 10],
                        outputRange: [-10, 10],
                  ...
                  elevation: confirmPasswordInputElevation,
                  shadowOpacity: confirmPasswordInputElevation.interpolate({
                    inputRange: [2, 8],
                    outputRange: [0.1, 0.3],
                  }),
                  shadowRadius: confirmPasswordInputElevation.interpolate({
                    inputRange: [2, 8],
                    outputRange: [4, 12],
                  }),
                },
